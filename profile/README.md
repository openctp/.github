...
openctp开发了一套基于CTP接口的Tick级策略交易框架，CTP接口的坑非常多，持仓与资金的实时计算很难处理，各种冻结、盈亏计算等，openctp给出了一套简洁的框架源码，保持了CTP原汁原味的数据结构，代码很漂亮，不到5000行，简洁易懂，二次开发很容易。第二期培训中免费赠送一套简版的Python版。付费版有更完善更专业的持仓与资金计算，以及更多专业的处理。
